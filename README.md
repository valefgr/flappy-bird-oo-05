...
En el lab anterior lograste que el juego termine cuando `bird` tenga una colisión con el suelo. En este lab vamos a agregar más código JavaScript para crear y dibujar un obstaculo.
...
1. Agrega la propiedad `juego.skyHeight`
2. Agrega la propiedad `obstaculos.obstacleContainer`
3. Agrega la propiedad `obstaculos.gap`
4. Agrega la propiedad `obstaculos.maxHeight`
5. Agrega la propiedad `obstaculos.minHeight`
6. Agrega la propiedad `obstaculos.width`
7. Agrega la propiedad `obstaculos.lista`
8. Agrega el método `obstaculos.crear()`
9. Agrega el método `obstaculos.dibujar()`
10. Llama a `obstaculos.crear()` dentro de `juego.iniciar()`
11. Llama a `obstaculos.dibujar()` dentro de `juego.loop()`
